...
Tab:AddButton("TP TO LOBBY", function()
...
if LocalPlayer:GetAttribute("Origin Loaded") then 
print("Origin already loaded")
...
Library:Notify("Loading Origin for DOORS",5)
...
LocalPlayer:SetAttribute("Origin Hub Loaded",true)
...
LocalPlayer:SetAttribute("Origin Loaded",false)
...
game.Players.LocalPlayer:SetAttribute("Origin Loaded",true)

local repo = 'https://raw.githubusercontent.com/mstudio45/LinoriaLib/main/'
local Executor = identifyexecutor()  or getexecutorname() 
local Library =  loadstring(game:HttpGet(repo..'Library.lua'))()
Library:Notify("Loading Origin for Legends of speed ",5)
task.wait(1.5)
Sound()
...
function Unload()
game.Players.LocalPlayer:SetAttribute("Origin Loaded",false)
...
Library:Notify("Loading Origin for OP Ninja Simulator ",5)
...
Window = Library:CreateWindow({
    Title = 'Origin Hub v4.5 |Op Ninja Simulator.    ',
    Center = true,
    AutoShow = true
})
...
Library:Notify("Loading Origin for Murder Mystery 2",5)
